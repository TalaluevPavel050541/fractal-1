...
2.	Порядок установки и настройки Git: книга «ProGit», глава 1.4 и 1.5 ссылка: https://git-scm.com/book/ru/v2
...
4.	Сделать fork репозитория с проектом: https://github.com/
